...
class BleClientClass {
    ...
    async hasBluetoothScanPermission() {
        const permissions = await this.queue(async () => {
    ...
    async hasBluetoothConnectPermission() {
        const permissions = await this.queue(async () => {
    ...
    async hasAccessFineLocationPermission() {
        const permissions = await this.queue(async () => {
    ...
    async requestBluetoothScanPermission() {
        const permissions = await this.queue(async () => {
    ...
    async checkAccessFineLocationPermission() {
        const permissions = await this.queue(async () => {
    ...
    async checkBluetoothScanPermission() {
        const permissions = await this.queue(async () => {
